import { ACTION_POST_ADD_OTHER_INFORMATION_REQUEST, ACTION_POST_PUBLISH_OTHER_INFORMATION_REQUEST, ACTION_GET_PUBLISH_OTHER_INFORMATION_LIST_REQUEST,ACTION_GET_PUBLISH_OTHER_INFORMATION_REQUEST } from "./SagaActionTypes"
...
export const actionGetPublishOtherInformationRequest = (payload) => {
    return {
        type: ACTION_GET_PUBLISH_OTHER_INFORMATION_REQUEST,
        payload: payload
    }
}
