          ...
          <Modal.Body>
            <div className="row">
              ...
              <div className="col-md-4">
                <strong>{tokens?.tokensrequired}</strong> &nbsp; Tokens
              </div>
            </div>
            <div className="row ">
              <div className="col-md-8">
        ...
        >
          ...
          <Modal.Body>
            ...
            <div style={{ marginTop: 20 }}>
              <p className="mailtext">{sendMailObj?.emailBody}</p>
            </div>
            ...
            <div style={{ marginTop: 40 }}>
              <p className="mailtext">
                <strong>Note:</strong> Please do not reply to this email as this
                is an unattended mail box.
              </p>
            </div>
          </Modal.Body>
          <Modal.Footer>
