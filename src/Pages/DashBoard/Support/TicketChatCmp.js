...
const TicketChatCmp = () => {
  ...
  const closedTkt =
    closedTicket !== undefined
      ? closedTicket?.filter((item) => item.ticketID === ticketNo)
      : "";
    ...
    <div className="container-body" style={{ overflow: "clip",marginTop:'100px' }}>
      <div className="ticket-chat-main">
        <div className="support-title">
          ...
          <div className="support-title-name">Support Team</div>
        </div>
          ...
          {ticketConvo && ticketConvo.length ? (
            ticketConvo.map((item) => (
              <div className="chat-container">
                <div
                  className={item.owner !== tpID ? "chat-admin" : "chat-user"}
                >
                  {item.query}
                  <div
                    className={
