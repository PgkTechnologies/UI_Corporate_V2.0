...
const Requests = (props) => {
  ...
  const onNotificationReceived = (id, status, initName, campusDriveID) => {
    setNotification(id);
                ...
                >
                  <div className="col-lg-9 col-sm-12 card-content">
                    ...
                    <div>
                      ...
                      from {item?.initiatorLocation} has sent a rquest to
                      conduct a Campus Drive with them
